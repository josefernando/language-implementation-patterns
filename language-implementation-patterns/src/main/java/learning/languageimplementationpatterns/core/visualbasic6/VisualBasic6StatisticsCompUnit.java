...
//		ParserRuleContext att = (ParserRuleContext) NodeExplorer.getFirstChildClass(ctx, LshAssignContext.class.getSimpleName());
	...
	public static void unitTest(String filePath) {
		...
		System.err.println("Parsing file: \"" + f.getAbsolutePath()+ "\"");
//		
//		URI uri = f.toURI();
//		URL url = null;
//		try {
...
//		System.err.println("Total Errors: " + parser.getNumErrors());
        ...
        if(visualBasic6InventoryCompUnit.getException().length() > 0 ) {   //!= null) {
	...
	public static void main(String[] args) {
		...
		unitTest("C:\\workspace\\workspace_desenv_java8\\visualbasic6\\antlr4.vb6\\input\\TIPMA00\\TIFMA001.FRM");
